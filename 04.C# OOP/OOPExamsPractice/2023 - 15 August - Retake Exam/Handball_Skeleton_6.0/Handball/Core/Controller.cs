...
namespace Handball.Core
{
    public class Controller : IController
    {
        ...
        public string LeagueStandings()
        {
            ...
            foreach (var team in this.teams.Models.OrderByDescending(p=>p.PointsEarned)
                .OrderByDescending(p=>p.OverallRating).ThenBy(p=>p.Name)) 
            {
        ...
        public string PlayerStatistics(string teamName)
        {
            ...
            foreach (var player in team.Players.OrderByDescending(t => t.Rating).ThenBy(t => t.Name)) 
            {
